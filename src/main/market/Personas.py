...
class Personas:
    ...
    class Persona:
        ...
        @classmethod
        def from_json(cls, json_str: str) -> "Personas.Persona":
            """
        ...
        @classmethod
        def from_dict(cls, data: dict[str, Any]) -> "Personas.Persona":
            """
    ...
    def __init__(self):
        ...
        self.persona: dict[str, "Personas.Persona"] = {}  # persona_id -> Persona lookup
    ...
    def load(self, file: str):
        ...
        if "personas" in data:
            for persona_data in data["personas"]:
                persona = self.Persona.from_dict(persona_data)
